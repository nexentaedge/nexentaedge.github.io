...
| cluster   | NexentaEdge cluster name to reduce command length  |  | false |
| forceBucketDeletion | Enforce bucket deletion during volume removement | false | false |
...
### Volume creation
 ...
 All volumes related to default cluster will be shown as tenant/bucket records in list, and can be passed to any docker volume command for run, mount, delete e.t.c
...
### Run container with non existent volume
